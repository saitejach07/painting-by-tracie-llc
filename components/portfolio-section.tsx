...
const projects = [
  ...
  },
  {
    ...
    category: "Commercial",
    beforeImage: "/images/portfolio-4.jpg",
  ...
  },
  {
    ...
    afterImage: "/images/yard-cleanup-after.jpg",
  ...
  },
  {
    ...
    category: "Exterior",
    beforeImage: "/images/portfolio-6.jpg",
  ...
  },
  {
    ...
    category: "Commercial",
    beforeImage: "/images/portfolio-8.jpg",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Browse our latest transformations. Hover over landscaping and yard clean-up projects to see before & after.
          </p>
        </div>
          ...
          {filteredProjects.map((project) => (
            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden bg-secondary">
                {/* Before/After image logic for landscaping and yard clean-up */}
                {(project.category === "Landscaping" || project.category === "Yard Clean-Up") ? (
                  <>
                    <Image
                      src={project.beforeImage}
                      alt={`${project.title} - Before`}
                      fill
                      className={`object-cover transition-opacity duration-500 ${hoveredProject === project.id ? 'opacity-0' : 'opacity-100'}`}
                    />
                    <Image
                      src={project.afterImage}
                      alt={`${project.title} - After`}
                      fill
                      className={`object-cover transition-opacity duration-500 ${hoveredProject === project.id ? 'opacity-100' : 'opacity-0'}`}
                    />
